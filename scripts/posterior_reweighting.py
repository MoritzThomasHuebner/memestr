...
from memestr.core.waveforms import time_domain_IMRPhenomD_waveform_with_memory, \
    time_domain_IMRPhenomD_waveform_with_memory_open_data, \
    time_domain_IMRPhenomD_memory_waveform
import copy

outdir = 'posterior_reweighting/cpnest_example'
...
reweighted_result = bb.result.read_in_result(outdir=outdir, label='reweighted')

# df = reweighted_result.posterior
...
#     print(i)
# reweighted_result.posterior = df
# reweighted_result.save_to_file(outdir='.')
