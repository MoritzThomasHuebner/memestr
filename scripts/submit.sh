...
bash IMR_mem_inj_mem_rec_mp.sh                 npoints=20 alpha=0.1 dlogz=100 zero_noise=True sampler=dynesty luminosity_distance=$1 label=IMR_mem_inj_mem_rec_mp
bash IMR_mem_inj_non_mem_rec_mp.sh             npoints=20 alpha=0.1 dlogz=100 zero_noise=True sampler=dynesty luminosity_distance=$1 label=IMR_mem_inj_non_mem_rec_mp
