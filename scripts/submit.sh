#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=5000 distance_marginalization=True alpha=0.1 zero_noise=False sampler=dynesty label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=5000 distance_marginalization=True alpha=0.1 zero_noise=False sampler=dynesty label=IMR_mem_inj_non_mem_rec
