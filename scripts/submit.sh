#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=True sampler=dynesty luminosity_distance=$1 distance_marginalization=True time_marginalization=False label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=True sampler=dynesty luminosity_distance=$1 distance_marginalization=True time_marginalization=False label=IMR_mem_inj_non_mem_rec
