...
#Population run
bash IMR_mem_inj_mem_rec.sh                 npoints=100 alpha=0.1 zero_noise=False sampler=cpnest nthreads=2 distance_marginalization=False duration=16 label=2_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=100 alpha=0.1 zero_noise=False sampler=cpnest nthreads=2 distance_marginalization=False duration=16 label=2_mem_inj_non_mem_rec
