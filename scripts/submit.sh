#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=3000 zero_noise=False sampler=dynesty label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=3000 zero_noise=False sampler=dynesty label=IMR_mem_inj_non_mem_rec
