...
#Population run
bash IMR_mem_inj_mem_rec.sh                 npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=False sampler=dynesty distance_marginalization=True duration=32 label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=False sampler=dynesty distance_marginalization=True duration=32 label=IMR_mem_inj_non_mem_rec
