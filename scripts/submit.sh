#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=1500 zero_noise=True sampler=dynesty label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=1500 zero_noise=True sampler=dynesty label=IMR_mem_inj_non_mem_rec
