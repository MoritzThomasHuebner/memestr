#!/usr/bin/env bash
#bash IMR_mem_inj_mem_rec.sh                 npoints=4000 zero_noise=False sampler=dynesty time_marginalization=True label=IMR_mem_inj_mem_rec
#bash IMR_mem_inj_non_mem_rec.sh             npoints=4000 zero_noise=False sampler=dynesty time_marginalization=True label=IMR_mem_inj_non_mem_rec
#bash IMR_non_mem_inj_non_mem_rec.sh         npoints=4000 zero_noise=False sampler=dynesty time_marginalization=True label=IMR_non_mem_inj_non_mem_rec
#bash IMR_non_mem_inj_mem_rec.sh             npoints=4000 zero_noise=False sampler=dynesty time_marginalization=True label=IMR_non_mem_inj_mem_rec
bash IMR_pure_mem_inj_pure_mem_rec.sh        npoints=4000 zero_noise=False sampler=dynesty label=IMR_pure_mem_inj_pure_mem_rec
