...
#Population run
bash IMR_mem_inj_mem_rec.sh                 npoints=100 alpha=0.1 zero_noise=False distance_marginalization=False sampler=cpnest nthreads=2 duration=16 label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=100 alpha=0.1 zero_noise=False distance_marginalization=False sampler=cpnest nthreads=2 duration=16 label=IMR_mem_inj_non_mem_rec
