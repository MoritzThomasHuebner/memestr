...
#Population run
bash IMR_mem_inj_mem_rec.sh                 npoints=2000 maxmcmc=2000 alpha=0.1 zero_noise=False sampler=cpnest distance_marginalization=True duration=16 label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=2000 maxmcmc=2000 alpha=0.1 zero_noise=False sampler=cpnest distance_marginalization=True duration=16 label=IMR_mem_inj_non_mem_rec
