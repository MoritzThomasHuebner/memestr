#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=2500 walks=80 zero_noise=True sampler=dynesty label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=2500 walks=80 zero_noise=True sampler=dynesty label=IMR_mem_inj_non_mem_rec
