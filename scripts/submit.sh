...
#Population run
bash IMR_mem_inj_mem_rec.sh                 npoints=2000 maxmcmc=1000 alpha=0.1 zero_noise=False distance_marginalization=True sampler=cpnest nthreads=4 duration=16 label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=2000 maxmcmc=1000 alpha=0.1 zero_noise=False distance_marginalization=True sampler=cpnest nthreads=4 duration=16 label=IMR_mem_inj_non_mem_rec
