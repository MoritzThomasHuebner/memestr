#!/usr/bin/env bash
bash IMR_mem_inj_mem_rec.sh                 npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=False sampler=dynesty sample=unif luminosity_distance=$1 distance_marginalization=True label=IMR_mem_inj_mem_rec
bash IMR_mem_inj_non_mem_rec.sh             npoints=5000 alpha=0.1 dlogz=0.1 zero_noise=False sampler=dynesty sample=unif luminosity_distance=$1 distance_marginalization=True label=IMR_mem_inj_non_mem_rec
