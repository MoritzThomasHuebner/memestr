...
memestr.wrappers.injection_recovery. \
    run_production_injection_imr_phenom(
        ...
        filename_base=0,
        outdir='0_pypolychord_production_IMR_non_mem_rec', label='IMR_mem_inj_non_mem_rec',
        ...
        sampling_frequency=2048, resume=True, clean=False, n_check_point=100, sub_run_id=5)
