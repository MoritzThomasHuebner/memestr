...
options['recovery_model'] = getattr(memestr.core.waveforms.models, str(options['recovery_model']), None)
options['reweight_model'] = getattr(memestr.core.waveforms.models, str(options['reweight_model']), None)
