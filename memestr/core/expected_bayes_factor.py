...
def expected_bayes_factor(**params):
    ...
    luminosity_distances = np.arange(200, 950, 50)
    log_bfs = []
    ...
    for luminosity_distance in luminosity_distances:
        ...
        waveform_generator_with_mem.parameters = parameters

        ifos = [bb.gw.detector.
                    get_interferometer_with_fake_noise_and_injection(name=name,
        ...
        likelihood_no_mem = bb.gw.likelihood.GravitationalWaveTransient(interferometers=ifos,
