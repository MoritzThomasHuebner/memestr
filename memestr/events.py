...
events = [
    ...
    Event(time_tag="1256999739-9", name="GW191105A", label="GW191105\_143521", detectors="H1L1V1", duration=16),
    ...
    Event(time_tag="1258804397-6", name="GW191126A", label="GW191126\_115259", detectors="H1L1", duration=16),
    ...
    Event(time_tag="1260567236-4", name="GW191216A", label="GW191216\_213338", detectors="H1V1", duration=16),
    ...
    Event(time_tag="1264693411-5", name="GW200202A", label="GW200202\_154313", detectors="H1L1V1", duration=32),
    ...
    Event(time_tag="1265361792-9", name="GW200210A", label="GW200210\_092254", detectors="H1L1V1", duration=32),
...
precessing_events = [
    ...
    Event(time_tag="1256999739-9", name="GW191105A_prec", label="GW191105\_143521", detectors="H1L1V1", duration=16),
    ...
    Event(time_tag="1258804397-6", name="GW191126A_prec", label="GW191126\_115259", detectors="H1L1", duration=16),
    ...
    Event(time_tag="1264693411-5", name="GW200202A_prec", label="GW200202\_154313", detectors="H1L1V1", duration=32),
